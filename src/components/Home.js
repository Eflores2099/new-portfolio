...
export default function Home() {
    return (
        <main>
            ...
            <img src={image} alt="Ergita Sela. the white theme" className="sm:bg-gradient-to-s  md:absolute object-cover w-full h-full bg-gradient-to-tr"/>
            ...
            <section className=" relative flex-col justify-center min-h-full pt-12 lg:pt-20 px-8" >
                <h1 className="sm:text-left text-purple-900 text-7xl leading-none lg:leading-snug home-name text-left">Erik Flores</h1>
